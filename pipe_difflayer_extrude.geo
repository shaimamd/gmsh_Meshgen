/*
   ...
   **Modified by Shaima Magdaline Dsouza , smdsouza@kth.se
   The cross section of the pipe extruded with different number of layers according to the partition ratio specified.
...
th=PI/4.;  //theta
lambda=0.3;   //=R_{arc}/R
Lz=14*D;   //length in z-dir (axial)
//***** Grid Paramaters
Nc=6;  // no. of nodes (=#elem+1) in azimuthal direction19
NB=1;   // no. of elemtns adjacent to the wall
NM=4;   // no. of nodes (=#elem+1) between the near wall layer and central square part8
...
Nz=28;    //no of elements in z-dire (axial)42
///////////////////////////////////////////////////
